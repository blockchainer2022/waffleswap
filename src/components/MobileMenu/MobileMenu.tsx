    ...
    return (
      <StyledMobileMenuWrapper>
        ...
        <StyledMobileMenu>
          ...
          <StyledLink exact activeClassName="active" to="/faq" onClick={onDismiss}>Proposals</StyledLink>
          <StyledLink exact activeClassName="active" to="/" onClick={onDismiss}>About</StyledLink>
